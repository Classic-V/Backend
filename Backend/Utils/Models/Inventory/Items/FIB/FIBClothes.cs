...
{
	public class FIBClothes : ItemBase
	{
		public override int Id => 35;

		public FIBClothes() : base("FIB Einsatzkleidung", 2f, 1)
		{
		}

		public override async Task<bool> Use(ClPlayer player, int slot, int amount)
		{
			if (player.DbModel.PlayerCachedClothes != null || player.DbModel.Team != 2 || !player.DbModel.Duty) return false;
